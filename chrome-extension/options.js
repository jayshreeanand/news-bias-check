...
function saveOptions(){
	// identify toggles
	var formElements = document.getElementById("bias-check-options").elements;
	...
	}, function(){ console.log("bias-check settings updated")});
}

// Restore radio buttons using preferences stored in chrome.storage
function restoreOptions(){
	var els = document.getElementById("bias-check-options").elements;
